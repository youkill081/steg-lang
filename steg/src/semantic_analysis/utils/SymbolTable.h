...
namespace compiler
{
    ...
    private:
        void setup_builtin_functions()
        {
            ...
            builtin("file_append_uint8", v(T::VOID), {v(T::UINT8), v(T::FILE)}, "FILE_APPEND_BYTE");
            builtin("file_append_uint16", v(T::VOID), {v(T::UINT16), v(T::FILE)}, "FILE_APPEND_WORD");
            builtin("file_append_little_uint16", v(T::VOID), {v(T::UINT16), v(T::FILE)}, "FILE_APPEND_WORD_LITTLE");
            builtin("file_append_uint32", v(T::VOID), {v(T::UINT32), v(T::FILE)}, "FILE_APPEND_DOUBLEWORD");
            builtin("file_append_little_uint32", v(T::VOID), {v(T::UINT32), v(T::FILE)}, "FILE_APPEND_DOUBLEWORD_LITTLE");
            builtin("file_write_uint8", v(T::VOID), {v(T::UINT8), v(T::FILE)}, "FILE_WRITE_BYTE");
            builtin("file_write_uint16", v(T::VOID), {v(T::UINT16), v(T::FILE)}, "FILE_WRITE_WORD");
            builtin("file_write_little_uint16", v(T::VOID), {v(T::UINT16), v(T::FILE)}, "FILE_WRITE_WORD_LITTLE");
            builtin("file_write_uint32", v(T::VOID), {v(T::UINT32), v(T::FILE)}, "FILE_WRITE_DOUBLEWORD");
            builtin("file_write_little_uint32", v(T::VOID), {v(T::UINT32), v(T::FILE)}, "FILE_WRITE_DOUBLEWORD_LITTLE");
